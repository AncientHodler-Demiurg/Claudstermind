...
export const DAEMON_PATHS = Object.freeze([
  ...
  "agent/agent.mjs",         // sessiond imports it (defaultPaths) — its copy goes stale on a change
  ...
  "lib/workspaceStore.mjs",  // the JSONL persistence store the engine reads/writes (transcripts, resume ids)
  "lib/worktrees.mjs",       // cwd/worktree resolution the engine runs per prompt
  "lib/claudeKeys.mjs",      // multi-key load/failover the engine runs
  "lib/omniRoute.mjs",       // OmniRoute model routing — claudeSession spawns/omni catalog read it
  "lib/protocol.mjs",        // the control-action contract the engine enforces
