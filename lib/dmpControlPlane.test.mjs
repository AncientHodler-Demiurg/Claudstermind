...
import { interpretHealthz, DMP_UNITS, DMP_PORT, DMP_MAIN_LOCAL_URL, controlDmpUnit } from "./dmpControlPlane.mjs";

test("DMP_PORT is frozen at 4002 and the main URL points at loopback", () => {
  assert.equal(DMP_PORT, 4002);
  assert.equal(DMP_MAIN_LOCAL_URL, "http://127.0.0.1:4002");
});
