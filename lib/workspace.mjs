...
export class WorkspaceManager {
  ...
  _control({ action, args = {} }) {
    ...
    switch (action) {
      ...
      case "resync": return this._resync(args.sessionKey, { scoped: !!args.scoped, full: !!args.full, limit: args.limit, around: args.around, aroundTurn: args.aroundTurn });
  ...
  _resync(sessionKey, { scoped = false, full = false, limit, around, aroundTurn } = {}) {
