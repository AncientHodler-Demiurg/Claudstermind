...
export class WorkspaceManager {
  ...
  _control({ action, args = {} }) {
    ...
    switch (action) {
      ...
      case "open": return this._openTranscript(args.sessionKey, { scoped: !!args.scoped });
      case "resync": return this._resync(args.sessionKey, { scoped: !!args.scoped });
  ...
  _liveOrSavedState(sessionKey, { scoped = false } = {}) {
  ...
  _openTranscript(sessionKey, { scoped = false } = {}) {
    const s = this._liveOrSavedState(sessionKey, { scoped });
  ...
  _resync(sessionKey, { scoped = false } = {}) {
