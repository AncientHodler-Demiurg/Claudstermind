...
export class WorkspaceManager {
  ...
  _control({ action, args = {} }) {
    ...
    switch (action) {
      ...
      case "open": return this._openTranscript(args.sessionKey, { scoped: !!args.scoped, full: !!args.full, limit: args.limit, around: args.around, aroundTurn: args.aroundTurn });
  ...
  _openTranscript(sessionKey, { scoped = false, full = false, limit, around, aroundTurn } = {}) {
