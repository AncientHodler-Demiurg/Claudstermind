...
/** Load every saved transcript, grouped by repo. Delegates to the store, which reads both the
 *  per-repo/per-worktree JSONL layout and legacy flat files. */
export function loadTranscripts(transcriptDir) {
  return store.loadAllByRepo(transcriptDir);
}
