...
import { parseSystemctlShow, UNITS, controlUnit } from "./controlPlane.mjs";
...
test("UNITS are the two managed services, engine first", () => {
  assert.deepEqual(UNITS.map((u) => u.id), ["engine", "web"]);
