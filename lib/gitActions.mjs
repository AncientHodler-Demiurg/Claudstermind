...
export function resolveRepo(localPath, root) {
  ...
  // Contain within the root. A bare startsWith(r) would admit a SIBLING like `../_ClaudeEvil`
  // (resolves to a path that string-prefixes the root) — require the root itself or a real
  // child under a separator.
