...
test("cleanClaudeEnv strips child-session vars but keeps the OAuth token + PATH", () => {
  const env = cleanClaudeEnv({ CLAUDECODE: "1", CLAUDE_CODE_CHILD_SESSION: "1", CLAUDE_CODE_OAUTH_TOKEN: "keep", PATH: "/x", HOME: "/h" });
