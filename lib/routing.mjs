...
export const DEFAULTS = Object.freeze({ omniEnabled: false, defaultPath: "claude", omniDefaultModel: "omni/auto" });
...
export function writeRoutingConfig(dataDir, patch = {}) {
  const next = normalizeRoutingConfig({ ...readRoutingConfig(dataDir), ...patch });
