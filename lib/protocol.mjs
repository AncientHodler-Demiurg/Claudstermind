...
// non-prompt operations the web may drive (create a folder/repo, list, set trusted-mode).
export const WS_CONTROL_ACTIONS = Object.freeze(["newFolder", "newRepo", "list", "setTrusted", "history", "delete"]);
